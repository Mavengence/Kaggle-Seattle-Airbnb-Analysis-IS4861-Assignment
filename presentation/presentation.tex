...
%	TITLE PAGE
%----------------------------------------------------------------------------------------
\title[Improve Airbnb's marketing]{How can the effectiveness of marketing be improved ‘Airbnb Seattle’?} % The short title appears at the bottom of every slide, the full title is only on the title page
\author{List Nicole ,
      L\"ohr Tim,\\
      Bohnstedt Timo,
      Pang Tsz Ching,
...
\titlegraphic{\includegraphics[width=3.5cm]{photo/cityUis}
}
\institute[Information Systems | IS4861 | Dr. Liu Junming] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
